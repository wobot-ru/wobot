...
$p=$db->query('SELECT a.post_content,b.ful_com_post,c.order_keyword FROM blog_post as a LEFT JOIN blog_full_com as b ON a.post_id=b.ful_com_post_id LEFT JOIN blog_orders as c ON a.order_id=c.order_id WHERE a.post_id='.intval($_GET['id']).' AND a.order_id='.intval($_GET['order_id']));

...
foreach ($top_post_value_positive as $post)
{
	...
	$outmas[1]['top_post_positive'][3][]=$post['post_content'];
...
foreach ($top_post_value_negative as $post)
{
	...
	$outmas[1]['top_post_negative'][3][]=$post['post_content'];
...
$outmas[3]['tags_to_xlsx']=$tags_to_xlsx;
		...
		$process=proc_open('perl /var/www/project/excel/xlsx.pl',$descriptorspec,$pipes,$cwd,$end);
		//echo "\n".$row['post_link']."\n";

...
// $_POST['order_id']='780';
// $_POST['start']='01.01.2013';
// $_POST['end']='01.02.2013';
// $_POST['format']='xls';
// $_POST['word_карту']=1;
// $_POST['start']='12.04.2012';
// $_POST['end']='11.02.2013';
// $_POST['order_id']=780;
$_POST['format']='xls';
$_POST['order_id']=780;
$_POST['page']=0;
$_POST['stime']='12.04.2012';
$_POST['etime']='11.02.2013';
$_POST['sort']=null;
$_POST['positive']=true;
$_POST['negative']=true;
$_POST['neutral']=true;
$_POST['post_type']=null;
$_POST['md5']='6de3e8e38a00c7aed834fd5f4ec92d72';
$_POST['perpage']=100;
$_POST['Promotions']='selected';
$_POST['words']='selected';
$_POST['tags']='selected';
$_POST['word_карту']=true;
//$user['user_id']=194;

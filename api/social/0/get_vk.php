...
$ord=$db->fetch($q);
$json=get_group_vk($ord['group_link'],$ord['group_start'],$ord['group_end'],7,($ord['vk_token']==''?'cf65276ccf101f2dcf101f2defcf3a60e0ccf10cf1f97d3fa830c78cd43e697':$ord['vk_token']));

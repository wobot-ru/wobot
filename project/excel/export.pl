...
$chart51->add_series(
    categories => '=Sheet5!$E$4:$E$12',
    values     => '=Sheet5!$F$4:$F$12',
    name       => 'Распределение сообщений по источникам',
);
$chart51->set_title( name => 'Источники' );
$worksheet5->insert_chart( 'A4', $chart51 );
...
$worksheet5->write( 'E20', $headings53, $boldborder );
$worksheet5->write( 'E21', $import->{5}->{top_count}, $border );

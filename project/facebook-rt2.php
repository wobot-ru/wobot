...
//{
	...
	//simple
	$link='https://graph.facebook.com/search?q=microsoft&type=post&limit=200&access_token='.(intval($last)>0?'&since='.intval($last):'');
	//echo $link;
	$out=parseurl2($link);
	//echo "==============================================\n";
	//echo $out;
	...
	[data] => Array
		...
		foreach ($data['data'] as $post)
		{
			...
			if (preg_match("/[а-я]/isu", $post_content)) {
			    //echo "rus\n";
				//echo "\033[1m".$post_content."\033[0m\n";
				echo date('r',$post_time)." ".$post_content."\n";
			} else {
			    //echo $post_content."\n";
			}

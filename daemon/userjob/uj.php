...
if (($gg1 % 2)==1)
{
$ressec=$db->query('SELECT * FROM robot_blogs2 WHERE blog_last_update=0 ORDER BY blog_id DESC');
}
else
{
$ressec=$db->query('SELECT * FROM robot_blogs2 WHERE blog_last_update<'.(time()-$deltatime*86400).' ORDER BY blog_id DESC LIMIT 10');
}

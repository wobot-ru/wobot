...
class apiREST {
  ...
  static function createRequestUri($basePath, $restPath, $params) {
	...
	//echo '//'.$paramName.'//';
	//print_r($paramSpec['value']);
          $queryVars[] = 'query' . '=' . rawurlencode($paramSpec['value']['query']);
          $queryVars[] = 'maxResults' . '=' . rawurlencode($paramSpec['value']['maxResults']);
          $queryVars[] = 'orderBy' . '=' . rawurlencode($paramSpec['value']['orderBy']);
          $queryVars[] = 'language' . '=' . rawurlencode($paramSpec['value']['language']);
          $queryVars[] = 'pageToken' . '=' . rawurlencode($paramSpec['value']['pageToken']);

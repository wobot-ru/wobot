...
$wordss=strtoupper('Очень красивый дизайн это наверное первое что бросается в глаза');
$words=explode(' ',$wordss);
//$words = array('ПОСЛЕ', 'СТАЛИ', 'ВИНА', 'И', 'РУКА', 'abc', 'ПРАВА');

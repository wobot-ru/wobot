...
require_once('/var/www/daemon/com/splitter.php');
...
{
	$post=preg_replace('/ё/isu','е',$post);
	$kw=preg_replace('/ё/isu','е',$kw);
	global $memcache;//,$post,$order,$blog;
	// if ($post['order_id']==9842 || $order['order_id']==9842 || $blog['order_id']==9842) return 1;
	// if ($post['order_id']==9843 || $order['order_id']==9843 || $blog['order_id']==9843) return 1;
...
// $text='паша очень хотел, чтобы мама купила ему Кораблик';
// $kw='паша & хотел';

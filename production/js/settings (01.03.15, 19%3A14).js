...
function makeSettingsDialog() {
  $('body').append('<div id="dialog-Password" class="mdialog" title="Смена пароля">\
    ...
    <a href="http://www.wobot.ru/tariff.php?noreg=1" target="_blank" ><span id="tarifinfo" class="ui-icon ui-icon-info" style="float: right;  "></span></a></div>\
...
$(document).ready(function () {
  ...
  if ($.cookie("tarif_id") == 5 || $.cookie("tarif_id") == 6 || $.cookie("tarif_id") == 7) {

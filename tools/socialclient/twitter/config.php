...
define('ENCRYPTION_KEY', 'iwqueryiowqur');

// OAuth consumer and secret keys. Available from http://twitter.com/oauth_clients
define('OAUTH_CONSUMER_KEY', 'M8RnwsZemYh62YS1dRW1Q');
define('OAUTH_CONSUMER_SECRET', 'ovIH2vVz82aMwaNpuBLm3i3nOUKvwgY8lR9M1z20E');

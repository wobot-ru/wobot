253
a:4:{s:8:"template";a:5:{s:31:"install.upgrade-application.tpl";b:1;s:11:"_header.tpl";b:1;s:14:"_statusbar.tpl";b:1;s:16:"_usermessage.tpl";b:1;s:11:"_footer.tpl";b:1;}s:9:"timestamp";i:1337207222;s:7:"expires";i:1337207822;s:13:"cache_serials";a:0:{}}<!DOCTYPE html>
    ...
    <div class="clearfix prepend_20 append_20">
     ...
     <div class="alert helpful">
         <p>
           ...
           Ready to upgrade ThinkUp to version 1.0.6.
         </p>
    </div>
    <br>
    <div>
        <p>
        <a href="/tools/thinkup/install/upgrade-application.php?run_update=1" onclick="$('#update-spinner').show();" class="linkbutton emphasized">Upgrade ThinkUp</a>
        </p>
        <p id="update-spinner" style="text-align: center; display: none;">
            <img src="/tools/thinkup/assets/img/loading.gif" width="50" height="50" />
        </p>
    </div>
            </div>
    </div>

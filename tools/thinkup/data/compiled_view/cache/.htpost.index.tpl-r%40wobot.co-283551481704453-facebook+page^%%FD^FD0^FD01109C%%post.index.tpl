513
a:5:{s:8:"template";a:9:{s:14:"post.index.tpl";b:1;s:11:"_header.tpl";b:1;s:14:"_statusbar.tpl";b:1;s:16:"_usermessage.tpl";b:1;s:24:"post.index._top-post.tpl";b:1;s:24:"_post.word-frequency.tpl";b:1;s:16:"_grid.search.tpl";b:1;s:26:"_post.author_no_counts.tpl";b:1;s:11:"_footer.tpl";b:1;}s:11:"insert_tags";a:1:{s:14:"dashboard_link";a:5:{i:0;s:6:"insert";i:1;s:14:"dashboard_link";i:2;s:14:"post.index.tpl";i:3;i:13;i:4;b:0;}}s:9:"timestamp";i:1332859265;s:7:"expires";i:1332859865;s:13:"cache_serials";a:0:{}}<!DOCTYPE html>
    ...
    <div class="grid_4 alpha omega" style=""> <!-- begin left nav -->
      <div id="nav">
        <ul id="top-level-sidenav">
          ...
          <li class="selected">
          <a href="?t=283551481704453&n=facebook+page">Replies&nbsp;&nbsp;&nbsp;</a>
          </li>
                      <li id="grid_search_input" style="padding:10px;">
          <form id="grid_search_form" action="/tools/thinkup/post">
          <input type="hidden" name="t" value="283551481704453" />
...
thisfield.value = defaulttext;
                                                  ...
                                                  <li><a href="?v=likes&t=283551481704453&n=facebook+page">Likes&nbsp;&nbsp;&nbsp;</a></li>
                            </ul>
...
<script src="//platform.twitter.com/widgets.js" type="text/javascript"></script>
   ...
   <a href="https://twitter.com/share" class="twitter-share-button"
      data-via="thinkupapp"
      data-text="В социальных медиа набирают силу обсуждения кандидатов в Президенты РФ. Мы решили не оставаться в стороне и начали анализировать активность политиков. Краткий отчёт за январь показывает, что уровень дискуссий с участием Путина очень велик, даже если убрать шум "кремлёвских ботов". Прохоров, как предмет обсуждения пользователей медиа, крепчает с каждым днём. Миронов и Зюганов по сравнению с первыми двумя кандидатами особого внимания еще не вызвали, за исключением всплеска обсуждений вокруг лидера КПРФ после шоу "К барьеру". Жириновский сдаёт позиции и пока ничем, кроме судебных скандалов, внимание общественности не привлёк. 
Нам интересна обратная связь: какие аналитические данные и метрики политических персон в социальных сетях вам интересны? 
Если этот формат найдёт одобрение и поддержку, будем делать подобные регулярно."
...
<g:plusone size="medium" annotation="none"></g:plusone>
           ...
           <!-- end if post -->
                ...
                <textarea cols="55" rows="2" id="txtarea" onClick="SelectAll('txtarea');">&lt;script src=&quot;http://bmstu.wobot.ru/tools/thinkup/api/embed/v1/thinkup_embed.php?p=283551481704453&n=facebook+page&quot;>&lt;/script></textarea>
                </div>
...
</div>                                <div id="post-replies-div" class="section">
                    <h2>Replies</h2>
...
<div class="individual-tweet post clearfix">
    <div class="grid_2 alpha">
      <div class="avatar-container">
                <img src="https://graph.facebook.com/100000635200626/picture" class="avatar2"/><img src="/tools/thinkup/plugins/facebook/assets/img/favicon.png" class="service-icon"/>
              </div>
    </div>
    ...
    <div class="grid_12 omega">
      <div class="post">
                              <div class="reply_text" id="reply_text-1">
            В первую очередь, конечно тональность и ключевые слова, с которыми упоминается та или иная персона. То есть, если количественные показатели будут разбавлены качественными, то цены вам не будет)
            </div>
      ...
      <div class="small gray">
       ...
       <span class="metaroll">
        <a href="/tools/thinkup/post/?t=651567&n=facebook page">2 months  ago</a>
        <!---->
                from 
...
<div class="individual-tweet post clearfix">
    <div class="grid_2 alpha">
      <div class="avatar-container">
                <img src="https://graph.facebook.com/642133123/picture" class="avatar2"/><img src="/tools/thinkup/plugins/facebook/assets/img/favicon.png" class="service-icon"/>
              </div>
    </div>
    <div class="grid_3 small">
              Andrei Kamarouski
    ...
    <div class="grid_12 omega">
      <div class="post">
                              <div class="reply_text" id="reply_text-2">
            Дайте линк на скачиваемую картинку в хорошем разрешении )
            </div>
      ...
      <div class="small gray">
       ...
       <span class="metaroll">
        <a href="/tools/thinkup/post/?t=651583&n=facebook page">2 months  ago</a>
        <!---->
                from 
...
<div class="individual-tweet post clearfix">
    ...
    <div class="grid_12 omega">
      <div class="post">
                              <div class="reply_text" id="reply_text-3">
            wobot, а тональность - это зелено-оранжево-серая полоска? Более подробно, для, скажем, не инетересно, так как я политикой поверхностно интересуюсь.&#10;Было бы не плохо иметь возможность, при желании, пройти за более подробной инфой..&#10;Вы тут будете выкладывать наблюдение?
            </div>
      ...
      <div class="small gray">
       ...
       <span class="metaroll">
        <a href="/tools/thinkup/post/?t=651596&n=facebook page">2 months  ago</a>
        <!---->
                from 
...
<div class="individual-tweet post clearfix">
    ...
    <div class="grid_12 omega">
      <div class="post">
                              <div class="reply_text" id="reply_text-4">
            Cossa, Lenta.ru (интернет). Я бы вас там читал)
            </div>
      ...
      <div class="small gray">
       ...
       <span class="metaroll">
        <a href="/tools/thinkup/post/?t=651779&n=facebook page">2 months  ago</a>
        <!---->
                from 
...
<div class="individual-tweet post clearfix">
    <div class="grid_2 alpha">
      <div class="avatar-container">
                <img src="https://graph.facebook.com/100001133732321/picture" class="avatar2"/><img src="/tools/thinkup/plugins/facebook/assets/img/favicon.png" class="service-icon"/>
              </div>
    </div>
    <div class="grid_3 small">
              Вадим Гузев
    ...
    <div class="grid_12 omega">
      <div class="post">
                              <div class="reply_text" id="reply_text-5">
            Чтобы было понятнее в будущем, нужно указывать не только &#34;с начала января&#34;, но и дату генерации самой картинки. А лучше конкретные даты (с 01.01.2012 по 26.01.2012). Кстати, думаю можно назвать этот репорт скажем &#34;Пульс выборов&#34; и попробовать продавать подписку на возможность его публикации всяким периодическим СМИ... Только это нужно делать быстро, пока тема актуальна ;)
            </div>
      ...
      <div class="small gray">
       ...
       <span class="metaroll">
        <a href="/tools/thinkup/post/?t=651811&n=facebook page">2 months  ago</a>
        <!---->
                from 
...
<div class="individual-tweet post clearfix">
    <div class="grid_2 alpha">
      <div class="avatar-container">
                <img src="https://graph.facebook.com/100000050162408/picture" class="avatar2"/><img src="/tools/thinkup/plugins/facebook/assets/img/favicon.png" class="service-icon"/>
              </div>
    </div>
    <div class="grid_3 small">
              Людмила Лаврова
    ...
    <div class="grid_12 omega">
      <div class="post">
                              <div class="reply_text" id="reply_text-6">
      ...
      <div class="small gray">
       ...
       <span class="metaroll">
        <a href="/tools/thinkup/post/?t=655446&n=facebook page">2 months  ago</a>
        <!---->
                from 
                ...
                <script src="/tools/thinkup/assets/js/extlib/Snowball.stemmer.min.js" type="text/javascript"></script>
                                <script src="/tools/thinkup/assets/js/word_frequency.js" type="text/javascript"></script>
                              </div>
            </div>

<?php /* Smarty version 2.6.26, created on 2012-03-27 18:40:21
         compiled from /var/www/tools/thinkup/plugins/facebook/view/friends.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', '/var/www/tools/thinkup/plugins/facebook/view/friends.tpl', 2, false),array('modifier', 'count', '/var/www/tools/thinkup/plugins/facebook/view/friends.tpl', 4, false),)), $this); ?>
<div class="section">
    <h2><?php if ($this->_tpl_vars['instance']->network == 'facebook page'): ?>Likes<?php else: ?>Friends<?php endif; ?> By Day <?php if ($this->_tpl_vars['follower_count_history_by_day']['trend']): ?><?php if ($this->_tpl_vars['follower_count_history_by_day']['trend'] > 0): ?>(<span style="color:green">+<?php else: ?><span style="color:red"><?php endif; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['follower_count_history_by_day']['trend'])) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
...
<div class="section">
    <h2><?php if ($this->_tpl_vars['instance']->network == 'facebook page'): ?>Likes<?php else: ?>Friends<?php endif; ?> By Week <?php if ($this->_tpl_vars['follower_count_history_by_week']['trend'] != 0): ?><?php if ($this->_tpl_vars['follower_count_history_by_week']['trend'] > 0): ?>(<span style="color:green">+<?php else: ?><span style="color:red"><?php endif; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['follower_count_history_by_week']['trend'])) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
    ...
    <div class="stream-pagination"><small style="color:gray">NEXT MILESTONE: <span style="background-color:#FFFF80;color:black"><?php echo $this->_tpl_vars['follower_count_history_by_week']['milestone']['will_take']; ?>
...
<div class="section">
    ...
    <div class="stream-pagination"><small style="color:gray">NEXT MILESTONE: <span style="background-color:#FFFF80;color:black"><?php echo $this->_tpl_vars['follower_count_history_by_month']['milestone']['will_take']; ?>

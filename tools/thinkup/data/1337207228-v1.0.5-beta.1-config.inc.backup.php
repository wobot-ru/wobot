...
$THINKUP_CFG['site_root_path']            = '/tools/thinkup/';
...
// Your timezone
$THINKUP_CFG['timezone']                  = 'Europe/Moscow';
...
$THINKUP_CFG['db_user']                   = 'wobot';
$THINKUP_CFG['db_password']               = 'JFHsvosd';
$THINKUP_CFG['db_name']                   = 'wobot';
...
|| (getenv("MODE")=="TESTS" && ! getenv("RD_MODE")=="1")) {
    ...
    $THINKUP_CFG['db_user']                   = 'wobot';
    $THINKUP_CFG['db_password']               = 'JFHsvosd';
    $THINKUP_CFG['db_name']                   = 'wobot'; //by default, thinkup_tests

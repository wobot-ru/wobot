...
if ($_GET['order_id']!='')
{
	$fp = fopen('/var/www/bot/elastic-spec.log', 'a');
	...
	$process=proc_open('php /var/www/daemon/fsearch3/elastic_job.php '.intval($_GET['order_id']).' '.(($_GET['start']!='')&&($_GET['end']!='')?$_GET['start'].' '.$_GET['end']:'').' &',$descriptorspec,$pipes,$cwd,$end);/* or {

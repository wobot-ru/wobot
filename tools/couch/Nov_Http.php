<?php
class Nov_Http_Exception extends Exception{
...
class Nov_Http
{
    ...
    private function _exec($type, $url, $params = array())
    {
        ...
        switch ($status) {
            ...
            default:
                if (!$this->_silentMode) {
                    throw new Nov_Http_Exception("http error: {$status}", $status);
                }
        }
        return $out;
    }
    ...
    private function _run()
    {
        ...
        foreach($curly as $id => $c) {
            ...
            switch ($status) {
                ...
                default:
                    if (!$this->_silentMode) {
                        $result[$id] = new Nov_Http_Multiple_Error($status, $type, $url, $params);
                    }
            }

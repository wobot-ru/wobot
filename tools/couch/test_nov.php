...
//UPDATE
//$couchDb->db('orders')->insert('gonzalo', array('password' => "g1"));
//$couchDb->db('orders')->update('gonzalo', array('password' => 'g2123'));
//$data = $couchDb->db('orders')->select('gonzalo')->asArray();
//print_r($data);
try {
    $couchDb->db('orders')->update('gonzalo', array('password' => 'g2'));

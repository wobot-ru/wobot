...
*******************/
	...
	imageCheckboxChecked="/img/checkboxChecked.gif";
	imageCheckboxUnchecked="/img/checkboxUnchecked.gif";
	imageRadioChecked="/img/radiobuttonChecked.gif";
	imageRadioUnchecked="/img/radiobuttonUnchecked.gif";
	imageSelectDropDownArrow="/img/selectDrop.gif";
...
//****		
	...
	function toggleCheck(realCheckId, fakeCheckId){
		...
		if(fakeCheck.src.indexOf("/img/checkboxChecked.gif") != -1){

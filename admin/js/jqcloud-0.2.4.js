  ...
  $.fn.jQCloud = function(word_array, options) {
    ...
    var drawWordCloud = function() {
      ...
      var drawOneWord = function(index, word) {
        ...
        var inner_html = word.url !== undefined ? "<a href='#' style=\"margin: 5px;\" onclick=\"document.getElementById(\'nname\').value=\'\'; document.getElementById(\'nword\').value=\'" + encodeURI(word.url).replace(/'/g, "%27") + "\'; document.getElementById(\'ncount\').value=\'" + encodeURI(word.weight).replace(/'/g, "%27") + "\'; document.getElementById('filternameform').action=\'/new/comment2\';document.getElementById('filternameform').submit();\">" + word.text + "</a>" : word.text;
